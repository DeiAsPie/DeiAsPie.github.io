...
try {
  ...
  if (chromePath) {
    ...
    // Must be a space-separated string: lhci concatenates this value with
    // " --headless=new", so an array turns into "a,b --headless=new" and every
    // flag but the last is lost. Losing --no-sandbox makes Chrome abort with
